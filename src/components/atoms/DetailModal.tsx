...
const DetailModal = ({ setIsModalOpen, title, description }: Props) => {
  const styles = {
    modal: {
      ...
      modalBox:
        "fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white w-11/12 md:w-1/2 h-1/2 rounded-3xl shadow-lg",
    ...
    button:
      "bg-blue-300 rounded-full w-16 h-8 flex justify-center items-center",
  };
